...
const registerTeacher = catchAsync(async(req, res, next)=>{
    let {_id,teacherTitile,teacherName,teacherAbbr,teacherNumber,teacherRole,teacherContact,teacherEmail,classTeacher} = req.body
...
const updateTecaher = catchAsync(async(req,res,next)=>{
    ...
    if(!req.body?.teacherTitile) teacherTitile = teachers.teacherTitile
